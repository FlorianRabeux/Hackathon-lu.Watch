...
module.exports = function(options, services, cb) {
    ...
    var
        cnt = content(options.root, services, options.deployDirs, contentPathsFilter, options.stripCRFromCSV),
        tasks = [],
        targetCreds,
        container,
        containerRole;
    ...
    tasks.push(function(cb) {
        privileges.grant(services, cnt, container, containerRole, cb);
    });
