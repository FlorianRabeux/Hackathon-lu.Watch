...
describe('fileset tests', function(){
    it('include test', function(){
        var fpath1 = "/sap/hana/epm/shine/procedures/my_proc.xsjslib"
        var fpath2 = "/sap/hana/epm/shine/procedure/my_proc.xsjslib"
        var fpath3 = "/sap/hana/epm/shine/procedures/my_xsjs.xsjs"
        var fpath4 = "procedures/my_proc.xsjslib"
    ...
    it('include dir test', function(){
        var fpath1 = "/sap/hana/epm/shine/procedures/my_proc.xsjslib"
        var fpath2 = "/sap/hana/epm/shine/procedures/sub/my_proc.xsjslib"
        var fpath3 = "procedures/my_proc.xsjslib"
