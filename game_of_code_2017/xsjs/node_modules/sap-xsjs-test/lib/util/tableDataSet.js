...
var ResultSet = require('sap-xsjs/lib/xsjs/db/dbapi/ResultSet.js')
	...
	*/
    ...
    addType2GetterMapping('BINARY', 'String');
    addType2GetterMapping('VARBINARY', 'String');
    ...
    function createColumn(metaData, columnIndex) {
		...
		metadataFunctions.forEach( function(metadataFunction){
             ...
             //samir : add check if the function is avaiable
		...
		/*
        return new ColumnDataSet(colMetaData, function(self) {
            return getGetterForType(colMetaData.ColumnType).bind(self, columnIndex)();
        });*/
		//var getterName = getGetterForType(colMetaData.ColumnType.getName())
    ...
    function importData(dataSet, resultSet) {
        function addToCol(col) {
            //col.addRow(col.getter(resultSet));
			col.addRow( resultSet[ col.getterName ](col.colIndex))
        }
    ...
    function createFromResultSet(resultSet) {
        ...
        createColumns(dataSet, resultSet.getMetaData());
