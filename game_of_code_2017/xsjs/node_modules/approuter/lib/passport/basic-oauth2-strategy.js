...
function BasicOAuth2Strategy(options, verify) {
  ...
  ['tokenURL', 'username', 'password', 'clientID', 'clientSecret'].forEach(function (propertyName) {
    checkProperty(options, propertyName);
  });
...
function checkProperty(options, propertyName) {
  if (!options[propertyName]) {
    throw new TypeError('BasicOAuth2Strategy requires a ' + propertyName + ' option');
  }
}
