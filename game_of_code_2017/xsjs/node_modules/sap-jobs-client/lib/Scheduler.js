...
Scheduler.prototype.fetchJobSchedule = function(options, done) {
  ...
  var req = {
    method: 'GET',
    uri: this._baseURL + '/' + options.jobId + '/schedules/' + options.scheduleId,
    qs: {
...
Scheduler.prototype.createJobSchedule = function(options, done) {
  ...
  var req = {
    method: 'POST',
    uri: this._baseURL + '/' + options.jobId + '/schedules',
...
Scheduler.prototype.updateJobRunLog = function(options, done) {
  ...
  var req = {
    method: 'PUT',
    uri: options.schedulerUrl || this._baseURL + '/' + options.jobId + '/schedules/' + options.scheduleId + '/runs/' + options.runId,
    body: options.data
  };
  this._sendRequest(req, done);
};
...
Scheduler.prototype.getRunLogs = function(options, done) {
  ...
  var req = {
    method : 'GET',
    uri : this._baseURL + '/' + options.jobId + '/schedules/' + options.scheduleId + '/runs'
  };
...
Scheduler.prototype.getRunLogsById = function(options, done) {
  ...
  var req = {
    method: 'GET',
    uri: this._baseURL + '/' + options.jobId + '/schedules/' + options.scheduleId + '/runs/' + options.runId
  };
